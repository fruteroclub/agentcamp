...
const navigation = [
  {
    name: 'Farcaster',
    href: 'https://warpcast.com/~/channel/comunidadesweb3',
...
export default function Footer({
  ...
  return (
    <footer className="w-full bg-background">
      <div className="mx-auto max-w-7xl px-4 pb-8 py-2 md:flex md:items-center md:justify-between md:px-6 lg:px-8">
